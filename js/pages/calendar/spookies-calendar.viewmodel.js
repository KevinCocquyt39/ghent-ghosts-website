var spookiesCalendarViewModel = function () {
    ...
    var q = $.ajax({
        type: "GET",
        url:
            "https://ghentghostsbackoffice.azurewebsites.net/api/events?teamKey=0c386889-63a9-4c65-b325-b9944079f70d&eventTypeId=1&apikey=235ddf70cce34e948500df101c15f294",
        data: null,
        dataType: "jsonp",
    });
    ...
    var q = $.ajax({
        type: "GET",
        url:
            "https://ghentghostsbackoffice.azurewebsites.net/api/events?teamKey=0c386889-63a9-4c65-b325-b9944079f70d&eventTypeId=2&apikey=235ddf70cce34e948500df101c15f294",
        data: null,
        dataType: "jsonp",
    });
